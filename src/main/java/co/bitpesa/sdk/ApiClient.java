...
public class ApiClient {
    ...
    private void init() {
        ...
        setUserAgent("Transferzero-SDK/Java7/1.0.0-SNAPSHOT");
    }
    ...
    public boolean validateWebhookRequest(String url, String body, HashMap<String, String> headers) throws ApiException {
      ...
      if (nonce == null || signature == null || key != getApiKey()) {
        return false;
      }

      StringBuilder headerSignature = signRequest(url, nonce, method, body);
    ...
    public Request buildRequest(String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, Object> formParams, String[] authNames, ApiCallback callback) throws ApiException {
        ...
        try {
            ...
            StringBuilder hmacResult = signRequest(url, nonce, method, bodyStr);
